...
| $$  \ $$| $$_____/| $$  | $$       /$$  \ $$ /$$__  $$  | $$ /$$| $$ \____  $$
| $$$$$$$/|  $$$$$$$|  $$$$$$$      |  $$$$$$/|  $$$$$$$  |  $$$$/| $$ /$$$$$$$/
|_______/  \_______/ \____  $$       \______/  \_______/   \___/  |__/|_______/ 
                     /$$  | $$                                                  
                    |  $$$$$$/                                                  
                     \______/                                                   

Discord - https://discord.gg/8u9zCjQ5PG
...
async def help(inter):
    ...
    server_name = inter.guild.name
    help = disnake.Embed(title="Bey Satış Help",description=f" ", color = 0xffffff, timestamp=datetime.datetime.utcnow())
    help.set_footer(text =f"{server_name}", icon_url="https://media.discordapp.net/attachments/1022172606029373521/1141487844381167748/BEYSATIS1.png")
...
async def invite(inter):
    ...
    await inter.message.reply("Server Invite: https://discord.gg/8u9zCjQ5PG")
...
async def test(ctx):
    ...
    await ctx.message.reply("Private Command :P |https://discord.gg/8u9zCjQ5PG")
